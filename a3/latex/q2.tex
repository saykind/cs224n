...
\begin{parts}
    ...
    \begin{center}
    \includegraphics[width=150mm]{example.jpg} \\
    \end{center}
    \newpage
     \begin{shaded}
    	\begin{answer}
    ...
    \end{shaded}
    \hspace*{-20mm}
    \begin{tabular}{ m{4.9cm} | m{6.2cm} | c | c }
    Stack & Buffer & New dependency & Transition \\ \hline \hline
    [R] & [I, attended, lectures, in, the, NLP, class] &  & Initial conf \\ \hline
    [R, I] & [attended, lectures, in, the, NLP, class] &  &  \texttt{SHIFT}  \\ \hline
    [R, I, attended] & [lectures, in, the, NLP, class] &  &  \texttt{SHIFT}  \\ \hline
    [R, attended] & [lectures, in, the, NLP, class] & attended$\to$I &  \texttt{LEFT-ARC}  \\ \hline
    [R, attended, lectures] & [in, the, NLP, class] &  &  \texttt{SHIFT} \\ \hline
    [R, attended] & [in, the, NLP, class] &  attended$\to$lectures &  \texttt{RIGHT-ARC} \\ \hline
    [R, attended, in] & [the, NLP, class] &  &  \texttt{SHIFT} \\ \hline
    [R, attended, in, the] & [NLP, class] &  &  \texttt{SHIFT} \\ \hline
    [R, attended, in, the, NLP] & [class] &  &  \texttt{SHIFT} \\ \hline
    [R, attended, in, the, NLP, class] &  &  &  \texttt{SHIFT} \\ \hline
    [R, attended, in, the, class] &  & class$\to$NLP &  \texttt{LEFT-ARC} \\ \hline 
    [R, attended, in, class] &  & class$\to$the &  \texttt{LEFT-ARC} \\ \hline
    [R, attended, class] &  & class$\to$in &  \texttt{LEFT-ARC} \\ \hline
    [R, attended] &  &  attended$\to$class &  \texttt{RIGHT-ARC} \\ \hline
    [R] &  &  R$\to$attended &  \texttt{RIGHT-ARC}
    \end{tabular}\newline
    ...
    \begin{shaded}
    	\begin{answer}
    		It will be parsed in $2n$ step, which consist of $n$ shifts and $n$ arcs (including last root arc).
    	\end{answer}
    \end{shaded}
...
\begin{shaded}
	\begin{answer}
		i. The university blocked the acquisition...
		\begin{itemize}
		...
		iii. Investment Canada declined to...
		\begin{itemize}
			\item \textbf{Error type}: Prepositional Phrase Attachment Error
...
\begin{shaded}
	\begin{answer}
		Using part-of-speech tags as features in a parser helps improve parsing accuracy by providing crucial information about word roles and grammatical structure in sentences, aiding in disambiguation and syntactic analysis.
	\end{answer}
\end{shaded}
